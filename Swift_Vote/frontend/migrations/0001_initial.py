    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='frontend.userdetails')),
            ],
        ),
        migrations.CreateModel(
            name='election',
            fields=[
                ...
                ('inCharge', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='frontend.userdetails')),
            ],
        ),
        migrations.CreateModel(
            name='location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frontend.userdetails')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='frontend.userdetails')),
            ],
        ),
    ]
